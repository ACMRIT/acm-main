                    ...
                    <div className="flex flex-col justify-between w-full">
                        <div className="space-y-8" >
                            ...
                            <div className="flex flex-row items-center space-x-4">
                                <button suppressHydrationWarning className="bg-lightBlue w-fit text-white py-[14px] px-[18px] rounded-md font-mullish font-bold hover:bg-lightBlue500 transition-all duration-200">
                                    <Link href={'/#joinus'} >
                                        Join Us Now
                                    </Link>
                                </button>
