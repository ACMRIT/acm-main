...
const Page = () => {
  return (
    <div className="flex flex-col justify-center pt-32 items-center bg-gradient-to-b from-deepBlueHead to-black text-black">
      ...
      <div className="flex flex-col items-center w-full space-y-8 sm:space-y-12 mb-16 sm:mb-20 px-4">
        <h2 className="text-3xl sm:text-5xl font-semibold font-titillium text-red-600 hover:scale-110 transition duration-300 text-center">
          Chapter Officers
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 sm:gap-10 w-full max-w-6xl place-items-center">
